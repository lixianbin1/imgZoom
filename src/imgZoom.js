/*!
 * imgZoom JavaScript Library v0.8.1
 * Author: lixianbin1
 * GitHub: https://github.com/lixianbin1/imgZoom
 * Date: 2022-04-02 11:22
 */
"use strict";
...
var imgZoom = function () {
  ...
  function create(url) {
    ...
    imgb.innerHTML = `
    <div id="_imgzoom" class="_imgzoom_box" style="width:` + imgwidth + `px;position:fixed;top:` + imgtop + `;left:` + imgleft + `;transform: translate(-50%,-50%);background:#fff;z-index: 1;-webkit-user-select: none;-moz-user-select: none;-ms-user-select: none;user-select:       none;padding:5px 10px 25px;">
